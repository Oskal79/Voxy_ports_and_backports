...
public class TerrainRenderPass {
    ...
    public RenderTarget getTarget() {
        return (this.isTranslucent && Minecraft.useShaderTransparency()) ? Minecraft.getInstance().levelRenderer.getTranslucentTarget() : Minecraft.getInstance().getMainRenderTarget();
    }
