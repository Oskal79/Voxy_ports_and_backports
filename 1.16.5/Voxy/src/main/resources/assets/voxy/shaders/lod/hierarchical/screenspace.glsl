...
bool isCulledByHiz() {
    #ifdef VOXY_NO_HIZ_CULL
    //Diagnostic: never occlusion-cull. If dark patches are missing sections rather than wrong data,
    //they come back as normal terrain with this on.
    return false;
    #endif
