...
public class MipGen {
    ...
    private static final class Cache {
        ...
        private final ByteArrayFIFOQueue QUEUE;

        public Cache(short[] SCRATCH, ByteArrayFIFOQueue QUEUE) {
            this.SCRATCH = SCRATCH;
            this.QUEUE = QUEUE;
        }

        public short[] SCRATCH() { return this.SCRATCH; }
        public ByteArrayFIFOQueue QUEUE() { return this.QUEUE; }

        @Override public boolean equals(Object obj) {
            if (this == obj) return true;
            if (!(obj instanceof Cache)) return false;
            Cache o = (Cache) obj;
            return java.util.Objects.equals(this.SCRATCH, o.SCRATCH) && java.util.Objects.equals(this.QUEUE, o.QUEUE);
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.SCRATCH, this.QUEUE); }

        @Override public String toString() { return "Cache[SCRATCH=" + this.SCRATCH + ", QUEUE=" + this.QUEUE + "]"; }
