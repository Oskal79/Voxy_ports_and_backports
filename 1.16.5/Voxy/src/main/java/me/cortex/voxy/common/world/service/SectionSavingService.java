...
public class SectionSavingService {
    ...
    private static final class SaveEntry {
        ...
        public SaveEntry(WorldEngine engine, WorldSection section) {
            this.engine = engine;
            this.section = section;
        }

        public WorldEngine engine() { return this.engine; }
        public WorldSection section() { return this.section; }

        @Override public boolean equals(Object obj) {
            if (this == obj) return true;
            if (!(obj instanceof SaveEntry)) return false;
            SaveEntry o = (SaveEntry) obj;
            return java.util.Objects.equals(this.engine, o.engine) && java.util.Objects.equals(this.section, o.section);
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.engine, this.section); }

        @Override public String toString() { return "SaveEntry[engine=" + this.engine + ", section=" + this.section + "]"; }
