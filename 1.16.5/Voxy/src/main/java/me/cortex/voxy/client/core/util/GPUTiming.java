...
public class GPUTiming {
    ...
    private static final class GlTimestampQuerySet <T> extends TrackedObject {
        ...
        private static final class InflightRequest<T> {
            ...
            private final TimingDataConsumer<T[]> callback;

            public InflightRequest(int[] queries, T[] meta, TimingDataConsumer<T[]> callback) {
                this.queries = queries;
                this.meta = meta;
                this.callback = callback;
            }

            public int[] queries() { return this.queries; }
            public T[] meta() { return this.meta; }
            public TimingDataConsumer<T[]> callback() { return this.callback; }

            @Override public boolean equals(Object obj) {
                if (this == obj) return true;
                if (!(obj instanceof InflightRequest)) return false;
                InflightRequest o = (InflightRequest) obj;
                return java.util.Objects.equals(this.queries, o.queries) && java.util.Objects.equals(this.meta, o.meta) && java.util.Objects.equals(this.callback, o.callback);
            }

            @Override public int hashCode() { return java.util.Objects.hash(this.queries, this.meta, this.callback); }

            @Override public String toString() { return "InflightRequest[queries=" + this.queries + ", meta=" + this.meta + ", callback=" + this.callback + "]"; }
