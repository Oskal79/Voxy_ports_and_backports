...
public final class WorldSection {
    ...
    static {
        try {
            ATOMIC_STATE_HANDLE = VarHandle.find(WorldSection.class, "atomicState", int.class);
            NON_EMPTY_CHILD_HANDLE = VarHandle.find(WorldSection.class, "nonEmptyChildren", byte.class);
            NON_EMPTY_BLOCK_HANDLE = VarHandle.find(WorldSection.class, "nonEmptyBlockCount", int.class);
            IN_SAVE_QUEUE_HANDLE = VarHandle.find(WorldSection.class, "inSaveQueue", boolean.class);
            IS_DIRTY_HANDLE = VarHandle.find(WorldSection.class, "isDirty", boolean.class);
