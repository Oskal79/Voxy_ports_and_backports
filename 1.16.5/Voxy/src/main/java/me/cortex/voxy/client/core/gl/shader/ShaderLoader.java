...
public class ShaderLoader {
    ...
    private static final class ShaderLoadingParser {
        ...
        private static List<String> toLines(String src) {
            // BufferedReader#readAllLines() is Java 24+; lines() works on 21 and throws nothing checked.
            return new BufferedReader(new StringReader(src)).lines().collect(java.util.stream.Collectors.toList());
        }
