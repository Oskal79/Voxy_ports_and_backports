...
public class OccupancySet2 {
    ...
    public void set(final int pos) {
        final long topBit = 1L<<me.cortex.voxy.common.util.Bits.compress(pos, 0b1100_1100_1100);
        final int  botIdx =     me.cortex.voxy.common.util.Bits.compress(pos, 0b0011_0011_0011);
