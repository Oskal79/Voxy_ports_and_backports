...
public abstract class TrackedObject {
    ...
    public static final class Ref {
        ...
        public Ref(Cleaner.Cleanable cleanable, boolean[] freedRef) {
            this.cleanable = cleanable;
            this.freedRef = freedRef;
        }

        public Cleaner.Cleanable cleanable() { return this.cleanable; }
        public boolean[] freedRef() { return this.freedRef; }

        @Override public boolean equals(Object obj) {
            if (this == obj) return true;
            if (!(obj instanceof Ref)) return false;
            Ref o = (Ref) obj;
            return java.util.Objects.equals(this.cleanable, o.cleanable) && java.util.Objects.equals(this.freedRef, o.freedRef);
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.cleanable, this.freedRef); }

        @Override public String toString() { return "Ref[cleanable=" + this.cleanable + ", freedRef=" + this.freedRef + "]"; }
