...
public class BasicAsyncGeometryManager implements IGeometryManager {
    ...
    private static final class SectionMeta {
        ...
        public SectionMeta(long position, int aabb, int geometryPtr, int itemCount, int[] offsets, byte childExistence) {
        ...
        public int aabb() { return this.aabb; }
        public int geometryPtr() { return this.geometryPtr; }
        public int itemCount() { return this.itemCount; }
        public int[] offsets() { return this.offsets; }
        public byte childExistence() { return this.childExistence; }

        @Override public boolean equals(Object obj) {
            if (this == obj) return true;
            if (!(obj instanceof SectionMeta)) return false;
            SectionMeta o = (SectionMeta) obj;
            return this.position == o.position && this.aabb == o.aabb && this.geometryPtr == o.geometryPtr && this.itemCount == o.itemCount && java.util.Objects.equals(this.offsets, o.offsets) && this.childExistence == o.childExistence;
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.position, this.aabb, this.geometryPtr, this.itemCount, this.offsets, this.childExistence); }

        @Override public String toString() { return "SectionMeta[position=" + this.position + ", aabb=" + this.aabb + ", geometryPtr=" + this.geometryPtr + ", itemCount=" + this.itemCount + ", offsets=" + this.offsets + ", childExistence=" + this.childExistence + "]"; }
