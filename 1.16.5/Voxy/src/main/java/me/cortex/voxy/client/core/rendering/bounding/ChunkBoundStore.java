...
public class ChunkBoundStore implements IBoundStore {
    ...
    public void preRender(Viewport<?> viewport) {
        if (!this.remQueue.isEmpty()) {
            ...
            this.remQueue.forEach((java.util.function.LongConsumer) this::_remPos);//TODO: REPLACE WITH SCATTER COMPUTE
            this.remQueue.clear();
        }
    }
    ...
    public void postRender(Viewport<?> viewport) {
        if (!this.addQueue.isEmpty()) {
            this.addQueue.forEach((java.util.function.LongConsumer) this::_addPos);//TODO: REPLACE WITH SCATTER COMPUTE
            this.addQueue.clear();
