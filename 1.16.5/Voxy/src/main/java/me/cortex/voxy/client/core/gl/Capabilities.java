...
public class Capabilities {
    ...
    public Capabilities() {
        ...
        this.INT64_t = testShaderCompilesOk(ShaderType.COMPUTE, """
                ...
                """);
        // LWJGL 3.2.2's GLCapabilities has no GL_KHR_shader_subgroup flag; probe the
        // extension string instead.
        if (org.lwjgl.opengl.GL.getCapabilities().GL_ARB_shader_group_vote) {
