...
public class OccupancySet {
    ...
    public void set(final int pos) {
        final long topBit = 1L<<me.cortex.voxy.common.util.Bits.compress(pos, 0b11000_11000_11000);
        final int  botIdx =     me.cortex.voxy.common.util.Bits.compress(pos, 0b00111_00111_00111);
