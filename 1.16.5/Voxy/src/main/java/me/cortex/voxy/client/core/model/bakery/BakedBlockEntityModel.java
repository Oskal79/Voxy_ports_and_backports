...
public class BakedBlockEntityModel {
    ...
    private static final class LayerConsumer {
        private final RenderType layer;
        private final ReuseVertexConsumer consumer;

        public LayerConsumer(RenderType layer, ReuseVertexConsumer consumer) {
            this.layer = layer;
            this.consumer = consumer;
        }

        public RenderType layer() { return this.layer; }
        public ReuseVertexConsumer consumer() { return this.consumer; }

        @Override public boolean equals(Object obj) {
            if (this == obj) return true;
            if (!(obj instanceof LayerConsumer)) return false;
            LayerConsumer o = (LayerConsumer) obj;
            return java.util.Objects.equals(this.layer, o.layer) && java.util.Objects.equals(this.consumer, o.consumer);
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.layer, this.consumer); }

        @Override public String toString() { return "LayerConsumer[layer=" + this.layer + ", consumer=" + this.consumer + "]"; }
    ...
    public static BakedBlockEntityModel bake(BlockState state) {
        ...
        var entity = ((ITileEntityProvider)state.getBlock()).newBlockEntity(BlockPos.ZERO, state);
        if (entity == null) {
            return null;
        }
