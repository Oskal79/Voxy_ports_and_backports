...
public class ModelStore {
    ...
    public ModelStore() {
        ...
        // 1.16.5's AtlasTexture does not retain its mip level; the terrain atlas is built from
        // the mipmapLevels video setting, so read that instead.
        int mipLvl = Minecraft.getInstance().options.mipmapLevels;
