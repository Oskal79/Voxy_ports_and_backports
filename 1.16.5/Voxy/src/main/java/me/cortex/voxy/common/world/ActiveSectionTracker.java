...
public final class ActiveSectionTracker {
    ...
    private static final class VolatileHolder <T> {
        ...
        static {
            try {
                PRE_ACQUIRE_COUNT = VarHandle.find(VolatileHolder.class, "preAcquireCount", int.class);
                POST_ACQUIRE_COUNT = VarHandle.find(VolatileHolder.class, "postAcquireCount", int.class);
