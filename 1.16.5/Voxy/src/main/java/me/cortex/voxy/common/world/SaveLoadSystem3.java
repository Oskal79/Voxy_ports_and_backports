...
public class SaveLoadSystem3 {
    ...
    private static final class SerializationCache {
        ...
        public SerializationCache(Long2ShortOpenHashMap lutMapCache, MemoryBuffer memoryBuffer) {
            this.lutMapCache = lutMapCache;
            this.memoryBuffer = memoryBuffer;
        }

        public Long2ShortOpenHashMap lutMapCache() { return this.lutMapCache; }
        public MemoryBuffer memoryBuffer() { return this.memoryBuffer; }

        @Override public boolean equals(Object obj) {
            if (this == obj) return true;
            if (!(obj instanceof SerializationCache)) return false;
            SerializationCache o = (SerializationCache) obj;
            return java.util.Objects.equals(this.lutMapCache, o.lutMapCache) && java.util.Objects.equals(this.memoryBuffer, o.memoryBuffer);
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.lutMapCache, this.memoryBuffer); }

        @Override public String toString() { return "SerializationCache[lutMapCache=" + this.lutMapCache + ", memoryBuffer=" + this.memoryBuffer + "]"; }
    ...
    public static int lin2z(int i) {//y,z,x
        ...
        int y = (i>>10)&0x1F;
        int z = (i>>5)&0x1F;
        return me.cortex.voxy.common.util.Bits.expand(x,0b1001001001001)|me.cortex.voxy.common.util.Bits.expand(y,0b10010010010010)|me.cortex.voxy.common.util.Bits.expand(z,0b100100100100100);

        //zyxzyxzyxzyxzyx
    }

    public static int z2lin(int i) {
        int x = me.cortex.voxy.common.util.Bits.compress(i, 0b1001001001001);
        int y = me.cortex.voxy.common.util.Bits.compress(i, 0b10010010010010);
        int z = me.cortex.voxy.common.util.Bits.compress(i, 0b100100100100100);
        return x|(y<<10)|(z<<5);
    }
