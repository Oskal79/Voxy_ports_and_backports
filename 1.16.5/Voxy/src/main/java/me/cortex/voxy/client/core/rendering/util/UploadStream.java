...
public class UploadStream {
    ...
    private static final class UploadFrame {
        private final GlFence fence;
        private final LongArrayList allocations;

        public UploadFrame(GlFence fence, LongArrayList allocations) {
            this.fence = fence;
        ...
        @Override public boolean equals(Object obj) {
            ...
            if (!(obj instanceof UploadFrame)) return false;
            UploadFrame o = (UploadFrame) obj;
            return java.util.Objects.equals(this.fence, o.fence) && java.util.Objects.equals(this.allocations, o.allocations);
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.fence, this.allocations); }

        @Override public String toString() { return "UploadFrame[fence=" + this.fence + ", allocations=" + this.allocations + "]"; }

    }
    private static final class UploadData {
        private final GlBuffer target;
        private final long uploadOffset;
        private final long targetOffset;
        private final long size;

        public UploadData(GlBuffer target, long uploadOffset, long targetOffset, long size) {
            this.target = target;
        ...
        public long uploadOffset() { return this.uploadOffset; }
        public long targetOffset() { return this.targetOffset; }
        public long size() { return this.size; }

        @Override public boolean equals(Object obj) {
            if (this == obj) return true;
            if (!(obj instanceof UploadData)) return false;
            UploadData o = (UploadData) obj;
            return java.util.Objects.equals(this.target, o.target) && this.uploadOffset == o.uploadOffset && this.targetOffset == o.targetOffset && this.size == o.size;
        }

        @Override public int hashCode() { return java.util.Objects.hash(this.target, this.uploadOffset, this.targetOffset, this.size); }

        @Override public String toString() { return "UploadData[target=" + this.target + ", uploadOffset=" + this.uploadOffset + ", targetOffset=" + this.targetOffset + ", size=" + this.size + "]"; }
